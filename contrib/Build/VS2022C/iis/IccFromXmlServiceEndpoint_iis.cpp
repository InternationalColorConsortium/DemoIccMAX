...
#include "EmbeddedUI_iccfromxml.h"
...
int main() {
  ...
  banner << L"\n=============================================\n";
  banner << L"[+] ICC Service Starting... NOT FOR COMMERCIAL USE (OR INTERNET FACING USE)... (c) David H Hoyt LLC 2020-2025\n";
  banner << L"    Timestamp   : " << timestampStream.str() << L"\n";
  banner << L"    Endpoint    : http://localhost:8182/iccfromxml\n";
