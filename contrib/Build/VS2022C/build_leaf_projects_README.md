...
```
cd C:\temp
iex (iwr -Uri "https://raw.githubusercontent.com/InternationalColorConsortium/DemoIccMAX/refs/heads/master/contrib/Build/VS2022C/build_leaf_projects_release.ps1").Content
```

## Overview
This PowerShell script is designed for building leaf projects. It automates tasks related to project build, ensuring an efficient workflow.

## Requirements
- Windows PowerShell

## Notes
Ensure all msbuild and vcpkg tools are installed
