...
function findWasmBinary() {
  return locateFile("scanicc.wasm");
}
...
function ___syscall_getdents64(fd, dirp, count) {
  try {
    ...
    for (var idx = startIdx; idx < endIdx; idx++) {
      ...
      _asan_js_store(HEAP64, ((dirp + pos) >> 3), BigInt(id));
      _asan_js_store(HEAP64, (((dirp + pos) + (8)) >> 3), BigInt((idx + 1) * struct_size));
      _asan_js_store(HEAP16, (((dirp + pos) + (16)) >> 1), 280);
      _asan_js_store(HEAP8, (dirp + pos) + (18), type);
...
function __gmtime_js(time, tmPtr) {
  ...
  _asan_js_store(HEAP32, ((tmPtr) >> 2), date.getUTCSeconds());
  _asan_js_store(HEAP32, (((tmPtr) + (4)) >> 2), date.getUTCMinutes());
  _asan_js_store(HEAP32, (((tmPtr) + (8)) >> 2), date.getUTCHours());
  _asan_js_store(HEAP32, (((tmPtr) + (12)) >> 2), date.getUTCDate());
  _asan_js_store(HEAP32, (((tmPtr) + (16)) >> 2), date.getUTCMonth());
  _asan_js_store(HEAP32, (((tmPtr) + (20)) >> 2), date.getUTCFullYear() - 1900);
  _asan_js_store(HEAP32, (((tmPtr) + (24)) >> 2), date.getUTCDay());
  var start = Date.UTC(date.getUTCFullYear(), 0, 1, 0, 0, 0, 0);
  var yday = ((date.getTime() - start) / (1e3 * 60 * 60 * 24)) | 0;
  _asan_js_store(HEAP32, (((tmPtr) + (28)) >> 2), yday);
}
...
var _main, _malloc, _free, _realloc, ___funcs_on_exit, _calloc, _emscripten_builtin_malloc, _emscripten_builtin_free, _emscripten_builtin_realloc, _emscripten_builtin_memalign, _emscripten_builtin_calloc, _memalign, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, __ZN6__asan9FakeStack17AddrIsInFakeStackEm, __ZN6__asan9FakeStack8AllocateEmmm, ___asan_loadN, ___asan_storeN;
...
function assignWasmExports(wasmExports) {
  ...
  Module["__ZN6__asan9FakeStack17AddrIsInFakeStackEm"] = __ZN6__asan9FakeStack17AddrIsInFakeStackEm = wasmExports["_ZN6__asan9FakeStack17AddrIsInFakeStackEm"];
  Module["__ZN6__asan9FakeStack8AllocateEmmm"] = __ZN6__asan9FakeStack8AllocateEmmm = wasmExports["_ZN6__asan9FakeStack8AllocateEmmm"];
