...
# OpenIccDev Project Governance

The OpenIccDev project is governed by its Committers, including a Technical
Steering Committee (TSC) which is responsible for high-level guidance of the
project.

## Contributors

The OpenIccDev project grows and thrives from assistance from Contributors.
...
The OpenIccDev GitHub repository is maintained by OICCD Committers. Committers
...
Committers, they become members of the OICCD leadership team.

Their privileges include, but are not limited to:

* Commit access to the OpenIccDev repository
...
valuable contributions to the OpenIccDev project to become a new Committer.

To nominate a new Committer, open an issue in the OICCD repository, with a
...
* Coordinating technical direction of the Project, including but not limited to:
    ...
    * Actively monitoring and assisting folks on the OICCD slack instance
...
will serve as the OpenIccDev ASWF (Academy Software Foundation) TAC (Technical
